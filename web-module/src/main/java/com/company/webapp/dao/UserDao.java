...
public class UserDao implements GenericDao<User> {
    ...
    @Override
    public boolean updateData(User object, String sqlQuery) {
        return false;
    }

    @Override
    public boolean deleteData(User object, String sqlQuery) {
        return false;
    }

    @Override
    public boolean insertData(User object, String sqlQuery) {
        return false;
    }
}
